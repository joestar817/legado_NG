...
```
* jsLib
> 注入JavaScript到RhinoJs引擎中，支持两种格式，可实现[函数共用](https://github.com/joestar817/legado/wiki/JavaScript%E5%87%BD%E6%95%B0%E5%85%B1%E7%94%A8)　
...
> 额外的变量[infoMap](https://github.com/joestar817/legado/blob/main/app/src/main/java/io/legado/app/utils/InfoMap.kt)可读取按钮的切换值
```js
//读取值
...
(function(){
  ...
  if(b64){
    ...
    var f2 = java.queryTTF("https://example.com/font.ttf");
...
> 部分变量说明：java（仅支持[js扩展类](https://github.com/joestar817/legado/blob/main/app/src/main/java/io/legado/app/help/JsExtensions.kt)），result为待解密图片的`ByteArray`，src为图片链接
