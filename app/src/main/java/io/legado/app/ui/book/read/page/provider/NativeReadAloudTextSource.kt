...
internal class NativeReadAloudTextSource(private val chapter: TextChapter) : ReadAloudTextSource {
    override val isReady: Boolean get() = chapter.isCompleted
    override val hasContent: Boolean
        get() = readAloudWholeChapterPageEndIndex(chapter.pageSize) != null
    override val text: String get() = pageText.readTextRange()
    override val paragraphs: List<ReadAloudParagraph> get() = chapter.getParagraphs(false)

    override val pageText: ReadAloudPageText = object : ReadAloudPageText {
